...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 06 mrt 2020 om 08:58
...
('AMS', 'Amsterdam', 'Nederland', 'West-Europa'),
('ANTAL', 'Antalya', 'Turkije', 'West-Europa'),
('ANTW', 'Antwerpen', 'Belgie', 'West-Europa'),
...
('BER', 'Berlijn', 'Duitsland', 'West-Europa'),
('BOGOT', 'Bogota', 'Colombia', 'Zuid-Amerika'),
('BRUS', 'Brussel', 'Brussel', 'West-Europa'),
...
('GRO', 'Groningen', 'Nederland', 'West-Europa'),
...
(24, 23, 29, '2019-08-12', 3, 0, '600.00'),
(25, 24, 30, '2019-05-05', 2, 3, '2250.00'),
(26, 25, 31, '2019-02-24', 1, 0, '950.00'),
(27, 26, 32, '2019-04-09', 2, 0, '3700.00'),
(28, 27, 33, '2019-01-12', 2, 1, '3000.00'),
(29, 28, 34, '2019-12-25', 4, 0, '2600.00'),
(30, 29, 35, '2019-06-11', 1, 0, '550.00'),
(31, 30, 36, '2020-01-15', 3, 0, '3750.00'),
(32, 31, 37, '2019-05-06', 6, 0, '900.00'),
(33, 32, 38, '2019-03-08', 2, 0, '1300.00');
...
(23, 'Hartsuiker N.', 'Hendrik Tollensstraat 142', '2624 BK', 'Delft', '0665589103'),
(24, 'Schoop A.', 'Meginhardweg 65', '6841 HB', 'Arnhem', '0650097791'),
(25, 'Helmink K.', 'Picardushofstee 38', '1935 GE', 'Egmond-Binnen', '0670629340'),
(26, 'Leegwater S.', 'Bergweg 154', '8431 GA', 'Oosterwolde', '0624502490'),
(27, 'Kaper E.', 'Bovendonk 42', '4707 ZT', 'Roosendaal', '0657395470'),
(28, 'Hartsuiker N.', 'Hendrik Tollensstraat 142', '2624 BK', 'Delft', '0665589103'),
(29, 'Latour T.', 'Kruimersweg 147', '7688 RH', 'Daarle', '0621219444'),
(30, 'Paans W-J.', 'Landsteinerweg 145', '9761 HH', 'Eelde', '0696238188'),
(31, 'Salih M.', 'Zilvergracht 189', '2652 HT', 'Berkel en Rodenrijs', '0681441147'),
(32, 'Groeneweg B.', 'Bakkerom 159', '9361 TA', 'Boerakker', '0678042960');
...
(29, 'AMS', '2020-03-08', 8, '200.00'),
(30, 'BRUS', '2020-06-12', 14, '450.00'),
(31, 'ROM', '2020-05-03', 21, '950.00'),
(32, 'SYD', '2020-06-08', 23, '1850.00'),
(33, 'VANC', '2020-04-22', 14, '1000.00'),
(34, 'ZUR', '2020-03-08', 7, '650.00'),
(35, 'ANTW', '2020-05-23', 14, '550.00'),
(36, 'MOS', '2020-04-04', 21, '1250.00'),
(37, 'GRO', '2020-02-14', 7, '150.00'),
(38, 'BER', '2020-08-19', 14, '650.00');
...
--
ALTER TABLE `boeking`
  MODIFY `Boekingnr` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `reis`
  MODIFY `Reisnr` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
